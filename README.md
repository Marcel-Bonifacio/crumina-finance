...
of your finances; parsed results are returned and then forgotten.
...
Crumina asks for read-only mailbox access and never sends, deletes or changes your
mail. Google refresh tokens, IMAP credentials and statement passwords are encrypted at
